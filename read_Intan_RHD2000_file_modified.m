...
%%%%function show_all_signals added by Ning
figure() ;  clf ;
    set( gcf, 'Color', 'White', 'Unit', 'Normalized', ...
        'Position', [0.1,0.1,0.6,0.6] ) ;
for plot_num=1:32
    subplot(8,4,plot_num)
    plot(t_amplifier(1:10*frequency_parameters.amplifier_sample_rate-1), amplifier_data(plot_num,1:10*frequency_parameters.amplifier_sample_rate-1))
end

    axes( 'Position', [0, 0.95, 1, 0.05] ) ;
    set( gca, 'Color', 'None', 'XColor', 'White', 'YColor', 'White' ) ;
    text( 0.5, 0, 'Show first 10 s signals: X Time(s), Y Amplitude(¦ÌV)', 'FontSize', 14', 'FontWeight', 'Bold', ...
